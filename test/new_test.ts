...
import { Treasure, IndexAdmin, PolylasticV3, PartnerProgram, DAOAdmin, IWETH, IndexLP } from '../typechain'
...
describe("1) Index Test (stake, unstake) #1)", () => {
  ...
  it("getContractAt tokens", async function () {
    ...
    polx = await ethers.getContractAt("contracts/POLX.sol:PolylasticV3", '0x187Ae45f2D361CbCE37c6A8622119c91148F261b') as PolylasticV3;
    matic = await ethers.getContractAt("contracts/POLX.sol:PolylasticV3", '0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270') as PolylasticV3;
    mv = await ethers.getContractAt("contracts/POLX.sol:PolylasticV3", '0xa3c322ad15218fbfaed26ba7f616249f7705d945') as PolylasticV3;
    sand = await ethers.getContractAt("contracts/POLX.sol:PolylasticV3", '0xbbba073c31bf03b8acf7c28ef0738decf3695683') as PolylasticV3;
    astrafer = await ethers.getContractAt("contracts/POLX.sol:PolylasticV3", '0xDfCe1e99A31C4597a3f8A8945cBfa9037655e335') as PolylasticV3;
    welt = await ethers.getContractAt("contracts/POLX.sol:PolylasticV3", '0x23e8b6a3f6891254988b84da3738d2bfe5e703b9') as PolylasticV3;
    fyn = await ethers.getContractAt("contracts/POLX.sol:PolylasticV3", '0x3B56a704C01D650147ADE2b8cEE594066b3F9421') as PolylasticV3;
    tel = await ethers.getContractAt("contracts/POLX.sol:PolylasticV3", '0xdF7837DE1F2Fa4631D716CF2502f8b230F1dcc32') as PolylasticV3;
    usdc = await ethers.getContractAt("PolylasticV3", '0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174') as PolylasticV3;
  })
  ...
  it("Initialize Index", async function () {
    ...
    let [addrIndexLP] = await index.getDataIndex();

    lp = await ethers.getContractAt("IndexLP", addrIndexLP) as IndexLP;

    let role = await index.connect(adminAddress).DAO_ADMIN_ROLE()
  ...
  it("Stake", async function () {
    ...
    await index.connect(addr[2]).stake(utils.parseEther('1'), amountUSD, percent)
    // const assets = await index.getActiveAssets();
    // console.log('ass=======', assets, '-=-=-=-=-=', await matic.balanceOf(index.address));
    // await matic.balanceOf(index.address);
