...
import { DAOAdmin, Treasure, PartnerProgram, IndexAdmin, FactoryAdmin, DAOCommunity, IndexCommunity, FactoryCommunity } from '../typechain'
...
async function main() {
...

    {
        ...
        partnerProgram = await PartnerProgram.deploy(PERCENT_REWARD, treasure.address, daoAdmin.address) as PartnerProgram;
...

    {
        ...
        console.log(`FactoryCommunity has been deployed to: ${factoryComm.address}`);
    }
}
